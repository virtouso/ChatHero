...
public class NodeSearchWindow : ScriptableObject, ISearchWindowProvider
{
    ...
    public bool OnSelectEntry(SearchTreeEntry SearchTreeEntry, SearchWindowContext context)
    {
        ...
        switch (SearchTreeEntry.userData)
        {
            ...
            PlayerNode playerResult=    _communicationGraphView.GeneratePlayerNode(localMousePosition);
                _communicationGraphView.AddElement(playerResult);

                return true;
            case 2:
                UnityEngine.Debug.Log("Add Character Node Pressed");
                CharacterNode characterResult = _communicationGraphView.GenerateCharacterNode(localMousePosition);
